...
AddPersonDialog::AddPersonDialog(QWidget *parent) : QDialog(parent) {
    ...
    // setWindowIcon(QIcon("../Pictures/add_person.png"));
    setModal(true);
...
void AddPersonDialog::setupUI() {
    ...
    // Create a separate style for cancel button
    ...
    cancelButton->setStyleSheet(cancelButtonStyle);  // Use the separate style
